...
- 🤖 LLM Engineering (RAG, agents, tooling, evaluation)  
- 🧩 Agentic AI systems (multi-step reasoning, tool use, workflows)  
...
### Programming & Core
![Python](https://img.shields.io/badge/Python-1572B4?style=for-the-badge&logo=python&logoColor=white)
